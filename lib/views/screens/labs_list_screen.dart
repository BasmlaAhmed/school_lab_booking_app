...
class _LabsListScreenState extends State<LabsListScreen> {
  ...
  void initState() {
    super.initState();
    Provider.of<LabProvider>(context, listen: false).fetchLabs();
  }
                    ...
                    subtitle: isAvailable
                        ...
                        : Column(
                            ...
                            children: [
                              ...
                              Text(
                                "From: ${formatLabTime(lab.fromTime)} \nTo: ${formatLabTime(lab.toTime)}",
                                style: TextStyle(
                                  fontSize: 14.sp,
                                  color: AppColor.textPrimary,
                                ),
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => ChangeNotifierProvider(
                            create: (_) =>
                                DeviceProvider(autoFetch: false)
